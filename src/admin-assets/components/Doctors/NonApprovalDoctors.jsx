...
import { Search, Loader2, ChevronLeft, ChevronRight, X, User, Mail, Phone, Calendar, Stethoscope, GraduationCap, Award, FileText, BadgeAlert } from "lucide-react";
...
// Non-Approved Doctor Profile Modal Component
...
export default function NonApprovalDoctors() {
  ...
  const fetchDoctors = useCallback(async () => {
    setLoading(true);
    try {
      let query = `/admin/non-approved-doctors-list/?page=${page}&limit=5`;
